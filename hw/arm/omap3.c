...
static uint64_t omap3_prm_readfn(void *opaque, hwaddr addr,
                                unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 4:
        return omap3_prm_read(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_prm_writefn(void *opaque, hwaddr addr,
                             uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        ...
        break;
    case 4:
        omap3_prm_write(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_prm_ops = {
    .read = omap3_prm_readfn,
    .write = omap3_prm_writefn,
...
static uint64_t omap3_cm_readfn(void *opaque, hwaddr addr,
                               unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        return omap_badwidth_read32(opaque, addr);
    case 4:
        return omap3_cm_read(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_cm_writefn(void *opaque, hwaddr addr,
                            uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        ...
        break;
    case 4:
        omap3_cm_write(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_cm_ops = {
    .read = omap3_cm_readfn,
    .write = omap3_cm_writefn,
    .valid.min_access_size = 1,
    .valid.max_access_size = 4,
    .endianness = DEVICE_NATIVE_ENDIAN,
};
...
static inline void omap3_wdt_timer_update(struct omap3_wdt_s *wdt_timer)
{
    ...
    if (wdt_timer->active) {
        expires = muldiv64(0xffffffffll - wdt_timer->wcrr,
                           NANOSECONDS_PER_SECOND, wdt_timer->rate);
...
static inline uint32_t omap3_wdt_timer_read(struct omap3_wdt_s *timer)
{
    ...
    if (timer->active) {
        ...
        distance = muldiv64(distance, timer->rate, NANOSECONDS_PER_SECOND);
...
static uint64_t omap3_mpu_wdt_readfn(void *opaque, hwaddr addr,
                                    unsigned size)
{
    switch (size) {
    case 1:
        return omap_badwidth_read32(opaque, addr);
    case 2:
        return omap3_mpu_wdt_read16(opaque, addr);
    case 4:
        return omap3_mpu_wdt_read32(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_mpu_wdt_writefn(void *opaque, hwaddr addr,
                                 uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
        ...
        break;
    case 2:
        omap3_mpu_wdt_write16(opaque, addr, value);
        break;
    case 4:
        omap3_mpu_wdt_write32(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_mpu_wdt_ops = {
    .read = omap3_mpu_wdt_readfn,
    .write = omap3_mpu_wdt_writefn,
    .valid.min_access_size = 1,
    .valid.max_access_size = 4,
    .endianness = DEVICE_NATIVE_ENDIAN,
};
...
static uint64_t omap3_scm_readfn(void *opaque, hwaddr addr,
                                unsigned size)
{
    switch (size) {
    case 1:
        return omap3_scm_read8(opaque, addr);
    case 2:
        return omap3_scm_read16(opaque, addr);
    case 4:
        return omap3_scm_read32(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_scm_writefn(void *opaque, hwaddr addr,
                             uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
        omap3_scm_write8(opaque, addr, value);
        break;
    case 2:
        omap3_scm_write16(opaque, addr, value);
        break;
    case 4:
        omap3_scm_write32(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_scm_ops = {
    .read = omap3_scm_readfn,
    .write = omap3_scm_writefn,
    .valid.min_access_size = 1,
    .valid.max_access_size = 4,
    .endianness = DEVICE_NATIVE_ENDIAN,
};
...
struct omap_mpu_state_s *omap3_mpu_init(MemoryRegion *sdram,
                                        int model)
{
    ...
    s->l4 = omap_l4_init(sysmem, OMAP3_L4_BASE, L4A_COUNT);

    s->ih[0] = qdev_create(NULL, "omap2-intc");
    qdev_prop_set_uint8(s->ih[0], "revision", 0x40);
    omap_intc_set_fclk(OMAP_INTC(s->ih[0]), omap_findclk(s, "omap3_mpu_intc_fclk"));
    omap_intc_set_iclk(OMAP_INTC(s->ih[0]), omap_findclk(s, "omap3_mpu_intc_iclk"));
    ...
    for (i = 0; i < 4; i++) {
        dma_irqs[i] = qdev_get_gpio_in(s->ih[omap3_dma_irq_map[i].ih],
                                   omap3_dma_irq_map[i].intr);
    }
    s->dma = omap3_dma4_init(omap3_l4ta_init(s->l4, L4A_SDMA), s, dma_irqs, 32,
    ...
    s->uart[0] = omap2_uart_init(sysmem, omap3_l4ta_init(s->l4, L4A_UART1),
                                 qdev_get_gpio_in(s->ih[0],
    ...
    s->uart[1] = omap2_uart_init(sysmem, omap3_l4ta_init(s->l4, L4A_UART2),
                                 qdev_get_gpio_in(s->ih[0],
    ...
    s->uart[2] = omap2_uart_init(sysmem, omap3_l4ta_init(s->l4, L4A_UART3),
                                 qdev_get_gpio_in(s->ih[0],
    ...
    if (model == omap3630) {
      s->uart[3] = omap2_uart_init(sysmem, omap3_l4ta_init(s->l4, L4A_UART4),
                                   qdev_get_gpio_in(s->ih[0],
...
*/
    ...
    omap2_gpio_set_iclk(OMAP2_GPIO(s->gpio), omap_findclk(s, "omap3_wkup_l4_iclk"));
    omap2_gpio_set_fclk(OMAP2_GPIO(s->gpio), 0, omap_findclk(s, "omap3_wkup_32k_fclk"));
    omap2_gpio_set_fclk(OMAP2_GPIO(s->gpio), 1, omap_findclk(s, "omap3_per_32k_fclk"));
    omap2_gpio_set_fclk(OMAP2_GPIO(s->gpio), 2, omap_findclk(s, "omap3_per_32k_fclk"));
    omap2_gpio_set_fclk(OMAP2_GPIO(s->gpio), 3, omap_findclk(s, "omap3_per_32k_fclk"));
    omap2_gpio_set_fclk(OMAP2_GPIO(s->gpio), 4, omap_findclk(s, "omap3_per_32k_fclk"));
    omap2_gpio_set_fclk(OMAP2_GPIO(s->gpio), 5, omap_findclk(s, "omap3_per_32k_fclk"));
    ...
    omap_i2c_set_iclk(OMAP_I2C(s->i2c[0]), omap_findclk(s, "omap3_i2c1_iclk"));
    omap_i2c_set_fclk(OMAP_I2C(s->i2c[0]), omap_findclk(s, "omap3_i2c1_fclk"));
    ...
    omap_i2c_set_iclk(OMAP_I2C(s->i2c[1]), omap_findclk(s, "omap3_i2c2_iclk"));
    omap_i2c_set_fclk(OMAP_I2C(s->i2c[1]), omap_findclk(s, "omap3_i2c2_fclk"));
    ...
    omap_i2c_set_iclk(OMAP_I2C(s->i2c[2]), omap_findclk(s, "omap3_i2c3_iclk"));
    omap_i2c_set_fclk(OMAP_I2C(s->i2c[2]), omap_findclk(s, "omap3_i2c3_fclk"));
