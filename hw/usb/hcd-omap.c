...
static uint64_t omap3_hsusb_otg_readfn(void *opaque, hwaddr addr,
                                           unsigned size)
{
    switch (size) {
    case 1:
        return omap3_hsusb_otg_readb(opaque, addr);
    case 2:
        return omap3_hsusb_otg_readh(opaque, addr);
    case 4:
        return omap3_hsusb_otg_readw(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_hsusb_otg_writefn(void *opaque, hwaddr addr,
                                        uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
        omap3_hsusb_otg_writeb(opaque, addr, value);
        break;
    case 2:
        omap3_hsusb_otg_writeh(opaque, addr, value);
        break;
    case 4:
        omap3_hsusb_otg_writew(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_hsusb_otg_ops = {
    .read = omap3_hsusb_otg_readfn,
    .write = omap3_hsusb_otg_writefn,
...
static void omap3_hsusb_otg_realize(DeviceState *dev, Error **errp)
{
    OMAP3HSUSBOTGState *s = OMAP3_HSUSB_OTG(dev);
    ...
    vmstate_register(VMSTATE_IF(dev), -1, &vmstate_omap3_hsusb_otg, s);
}

static void omap3_hsusb_otg_class_init(ObjectClass *klass, void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);
    dc->realize = omap3_hsusb_otg_realize;
...
static uint64_t omap3_hsusb_host_readfn(void *opaque, hwaddr addr,
                                            unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        return omap_badwidth_read32(opaque, addr);
    case 4:
        return omap3_hsusb_host_read(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_hsusb_host_writefn(void *opaque, hwaddr addr,
                                     uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        ...
        break;
    case 4:
        omap3_hsusb_host_write(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_hsusb_host_ops = {
    .read = omap3_hsusb_host_readfn,
    .write = omap3_hsusb_host_writefn,
    .valid.min_access_size = 1,
    .valid.max_access_size = 4,
    .endianness = DEVICE_NATIVE_ENDIAN,
};
...
static uint64_t omap3_hsusb_ehci_readfn(void *opaque, hwaddr addr,
                                            unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        return omap_badwidth_read32(opaque, addr);
    case 4:
        return omap3_hsusb_ehci_read(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_hsusb_ehci_writefn(void *opaque, hwaddr addr,
                                     uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        ...
        break;
    case 4:
        omap3_hsusb_ehci_write(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_hsusb_ehci_ops = {
    .read = omap3_hsusb_ehci_readfn,
    .write = omap3_hsusb_ehci_writefn,
    .valid.min_access_size = 1,
    .valid.max_access_size = 4,
    .endianness = DEVICE_NATIVE_ENDIAN,
};
...
static uint64_t omap3_hsusb_tll_readfn(void *opaque, hwaddr addr,
                                            unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        return omap_badwidth_read32(opaque, addr);
    case 4:
        return omap3_hsusb_tll_read(opaque, addr);
    default:
        g_assert_not_reached();
    }
}

static void omap3_hsusb_tll_writefn(void *opaque, hwaddr addr,
                                     uint64_t value, unsigned size)
{
    switch (size) {
    case 1:
    ...
    case 2:
        ...
        break;
    case 4:
        omap3_hsusb_tll_write(opaque, addr, value);
        break;
    default:
        g_assert_not_reached();
    }
...
static const MemoryRegionOps omap3_hsusb_tll_ops = {
    .read = omap3_hsusb_tll_readfn,
    .write = omap3_hsusb_tll_writefn,
    .valid.min_access_size = 1,
    .valid.max_access_size = 4,
    .endianness = DEVICE_NATIVE_ENDIAN,
};

static void omap3_hsusb_host_realize(DeviceState *dev, Error **errp)
{
    OMAP3HSUSBHostState *s = OMAP3_HSUSB_HOST(dev);
    SysBusDevice *sbd = SYS_BUS_DEVICE(dev);
    ...
    vmstate_register(VMSTATE_IF(s), -1, &vmstate_omap3_hsusb_host, s);
}

static void omap3_hsusb_host_class_init(ObjectClass *klass, void *data)
{
    DeviceClass *dc = DEVICE_CLASS(klass);
    dc->realize = omap3_hsusb_host_realize;
